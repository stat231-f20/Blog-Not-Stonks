...
# Introduction
In this project, we will explore international trade relationships. Trade between countries plays a huge role in the development of several sectors of their individual economies, creating millions of jobs worldwide. Through trade countries are able to produce and export goods in which they have the comparative advantage and import goods that other countries have more efficient production in. This leads to accelerated growth for countries' economies and financial markets. In particular, we would like to visualize these relationships, and identify natural groupings among countries, as well as figure out how much trade is involved within different country groups.
...
# Overview
To understand the inner workings of international trade, we create a spatial data graph of the World and a trade network of clusters. This spatial graph is colored by export and import percentage. We were interested to see the relationship between exporting and importing percentages. The clusters were chosen through unsupervised learning by volume (in terms of value) of trade. The first network graph is the network of the high volume (in terms of value) trade, where the thickness of arrows represent the amount in terms of value traded. The second network graph shows the trade between the medium trade volume countries. 
